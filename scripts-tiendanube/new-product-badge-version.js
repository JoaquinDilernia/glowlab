...
(function() {
  ...
  // URL de la API
  const API_URL = 'https://glowlab-production.up.railway.app';
  ...
  function addBadgeToProduct(productElement, createdAt) {
    ...
    if (!imageContainer) {
      console.warn('⚠️ No se encontró contenedor para badge en:', productElement);
      return;
    }
    ...
    console.log('✅ Badge agregado a producto');
  }
