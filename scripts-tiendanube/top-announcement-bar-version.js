...
(function() {
  ...
  if (!storeId) return;
  fetch('https://glowlab-production.up.railway.app/api/top-announcement-bar-widget.js?store=' + encodeURIComponent(storeId), { credentials: 'omit' })
    .then(function(r) { return r.text(); })
    .then(function(code) { (0, eval)(code); })
    .catch(function() { window.__promonubeTopAnnouncementBootstrap = false; });
})();
